...
void Update (void)
{
     ...
     s_finalRotation = Matrix4::rotationZYX(Vector3(s_accumulatedTurningAngleY, -s_accumulatedTurningAngleX, 0.0f));
...
/* -----------------------------------------------------------------
    ...
    sceGxmSetUniformDataF( vertexDefaultBuffer, s_rotParam, 0, 16, (float*)&s_finalRotation );
